...
vae, var = build_vae_var(
    V=1024, Cvae=256, ch=128, share_quant_resi=1,
...
ckpt = torch.load("local_output_freqar/ar-ckpt-best.pth")["trainer"]
...
dataset = build_dataset("cifar_images", final_reso=32)[-1]
dataloader = torch.utils.data.DataLoader(dataset, batch_size=B, shuffle=True, num_workers=4)
